...
<a href="index.do?param=index">index.do호출</a>
<a href="a.do?param=a">a.do호출</a>
<a href="b.do?param=b">b.do호출</a>
<a href="yana.do?param=너도할수있어">yana.do호출</a>
